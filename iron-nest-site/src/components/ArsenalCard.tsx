...
export default function ArsenalCard({ href, chip, title, subtitle, description, bannerHue = 47, image }: ArsenalCardProps) {
  return (
    <Link href={href} className="card group flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 className="text-xl font-600 uppercase leading-snug text-[var(--color-moon)] transition-colors group-hover:text-[var(--color-amber)]">
          {title}
        </h3>
        <p className="font-[var(--font-display)] text-sm uppercase tracking-wide text-[var(--color-amber-deep)]">
          {subtitle}
        </p>
